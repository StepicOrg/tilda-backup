...
function t650_init(recId){t_onFuncLoad('t_cards__moveClickOnCard',function(){t_cards__moveClickOnCard(recId)});t_onFuncLoad('t_cards__addFocusOnTab',function(){t_cards__addFocusOnTab(recId)})}
