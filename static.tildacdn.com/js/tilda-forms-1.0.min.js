...
var arLang=window.tildaForm.arValidateErrors[window.tildaBrowserLang]||{};var $fieldgroup,isFieldErrorBoxExist,isShowCommonErrors,$errItem,sError='',sCommonError='';var $popupError=$('#tilda-popup-for-error');if($popupError.length==0){$('body').append('<div id="tilda-popup-for-error" class="js-global-errorbox-all t-form__errorbox-wrapper t-global__errorbox-wrapper" style="display: none;"> <div class="t-form__errorbox-text t-text t-text_xs"> error </div> <div class="tn-form__errorbox-close js-errorbox-close"> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-left"></div> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-right"></div> </div> </div>');$popupError=$('#tilda-popup-for-error')}
...
window.errorTimerID=window.setTimeout(function(){tildaForm.hideErrors($jform);window.errorTimerID=0},10000);$jform.off('focus change','.js-tilda-rule');$jform.on('focus change','.js-tilda-rule',function(){tildaForm.hideErrors($jform);if(window.errorTimerID){window.clearTimeout(window.errorTimerID);window.errorTimerID=0}});$jform.trigger('tildaform:aftererror');return!0};window.tildaForm.showErrors=function($jform,arErrors){if(!arErrors||arErrors.length==0){return!1}
