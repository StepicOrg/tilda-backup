...
window.Tilda=window.Tilda||{};(function($){Tilda.sendEventToStatistics=function(virtPage,virtTitle,referer,price){var isVirtPage=virtPage.substring(0,1)=='/'?!0:!1;var arProducts=[],p=0;var noFbSendEvent=$('#allrecords').data('fb-event');noFbSendEvent=(noFbSendEvent&&noFbSendEvent=='nosend'?!0:!1);var currencyCode='';currencyCode=$('#allrecords').data('tilda-currency')||$('.t706').data('project-currency-code')||'RUB';if(!referer){referer=window.location.href}
