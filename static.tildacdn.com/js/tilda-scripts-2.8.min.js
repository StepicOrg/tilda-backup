...
if(window.mainMailruId>"0"){var _tmr=window._tmr||(window._tmr=[]);if(isVirtPage){if(price>0){_tmr.push({id:""+window.mainMailruId,type:"pageView",url:virtPage,start:(new Date()).getTime()})}else{}}else{if(price>0){_tmr.push({id:""+window.mainMailruId,type:"reachGoal",goal:virtPage,value:price})}else{_tmr.push({id:""+window.mainMailruId,type:"reachGoal",goal:virtPage})}}}
